...
public static class QsCommands
{
    ...
    public static bool CheckCommand(string command)
    {
        ...
        if (commands[0] == "cls" || commands[0] == "clear")
        {
            Console.Clear();
            CommandProcessed = true;
        }
        ...
        if (commands[0] == "cache")
        {
            ...
            else 
            {
                if (commands[1] == "clear" )
                {
                    if (commands.Length < 3)
                    {
                        Unit.ClearUnitsCaching();
                        Console.WriteLine("    Units Cached Cleared.");
                    }
                    else
                    {
                        if (command.Length < 4)
                        ...
                        {
                            if (commands[2] == "dynamic")
                            {
                                Unit.ClearDynamicUnitsCaching();
                                Console.WriteLine("    Dynamic Units Caching Cleared.");
                            }
